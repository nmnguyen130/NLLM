...
def get_ds(config):
    ...
    for d in ds_raw:
        src_ids = tokenizer_src.encode(d['translation'][config['lang_src']]).ids
        tgt_ids = tokenizer_tgt.encode(d['translation'][config['lang_tgt']]).ids
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        for batch in batch_iterator:
            ...
            label = batch['label'].to(device)  # (batch_size, seq_len, tgt_vocab_size)
